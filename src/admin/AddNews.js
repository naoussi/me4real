...
import { Form, Button, Spinner, Row, Col, Toast, } from 'react-bootstrap'
...
class AddNews extends React.Component {
    ...
    handleSubmit = event => {
        ...
        if (this.props.newsItem) {
            this.props.handleAddNews({ image: this.state.image, title: this.state.title, description: this.state.description, filename: this.state.filename, rank: this.state.rank, id: this.props.newsItem._id }, true)
        }
        else {
            this.props.handleAddNews({ image: this.state.image, title: this.state.title, description: this.state.description, filename: this.state.filename, rank: this.state.rank }, false)
    ...
    componentDidMount() {
        if (this.props.newsItem) {
            this.mockd = this.props.newsItem.description;
            this.setState({ title: this.props.newsItem.title, description: this.props.newsItem.description, rank: this.props.newsItem.rank, image: this.props.newsItem.image })
        }
    }
    render() {
        return (
            <div >
                ...
                <Row>
                    <Col xs={12}>
                        <Toast onClose={() => this.setState({saved: false})} show={this.props.saved}>
                            <Toast.Header>
                                <strong className="mr-auto">Me4real</strong>
                                <small>less than 1 mins ago</small>
                            </Toast.Header>
                            <Toast.Body>Woohoo, News Was successfully saved!</Toast.Body>
                        </Toast>
                    </Col>
